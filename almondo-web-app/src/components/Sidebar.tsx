...
const Sidebar = ({isOpen} : {isOpen: boolean}) => {
    return (
        <div className={`transition-[width] duration-500 ease-in-out absolute top-0 left-0 ${isOpen ? 'w-full lg:w-1/2 xl:w-1/3': 'w-0'} pt-20 h-full z-10 border border-gray-300 rounded-tr-xl shadow-lg/20 bg-[#FFFFFF] overflow-hidden`}>
